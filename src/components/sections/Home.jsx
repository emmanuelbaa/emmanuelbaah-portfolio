...
export const Home = () => {
  return (
    <section
      id="home"
      className="relative flex min-h-screen items-center p-20 justify-center overflow-hidden bg-gradient-to-r from-[#4f47c8]/20 via-[#dbe5ff]/60 to-[#1dd5d0]/10"
    >
      ...
      <AppearOnScroll>
        <div className="z-10 mx-auto w-full max-w-6xl px-6 py-16">
          <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
            <div className="text-center md:text-left">
              <h1 className="mb-5 text-4xl font-bold leading-tight text-[#1e3a8a] md:text-5xl">
              ...
              <div className="flex flex-col items-center gap-4 sm:flex-row md:items-start">
                <a
                  ...
                  hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(0,255,255,0.55)]"
                >
                ...
                <a
                  href="#contact"
                  className="rounded-md border border-[#1e3a8a]/40 bg-white/40 px-8 py-3 font-medium text-[#1e3a8a] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1
            ...
            <div className="relative mx-auto mt-6 w-fit md:mt-0 md:ml-auto">
              <span className="absolute -top-6 -right-4 z-20 text-[#1e3a8a]">
              ...
              <div className="absolute left-24 -top-6 z-20 h-6 w-6">
              ...
              <div className="overflow-hidden rounded-2xl border mt-5 border-white/40 bg-white/40 p-3 shadow-2xl backdrop-blur-md">
                <img
                  src={baahImg}
                  alt="Emmanuel Baah"
